...
//
//@Configuration
//public class KafkaMerchHierarchyUpdatesConfig {
//
//	@Value("${merch.hierarchy.updates.bootstrap.servers}")
//	private String bootStrapServers;
//	
//	@Value("${merch.hierarchy.updates.acks}")
//	private String acks;
//	
//	@Value("${merch.hierarchy.updates.retries}")
...
//	
//	@Value("${merch.hierarchy.updates.publish.topic.name}")
